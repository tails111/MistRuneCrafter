...
public class Globals {
    ...
    public static int RUNE_ASTRAL_AMOUNT = 2, RUNE_WATER_AMOUNT = 45;
    ...
    public static int[] ITEMS_OPTIONAL = {ID_GIANT_POUCH_DEG,ID_LARGE_POUCH,ID_GIANT_POUCH};
    public static int[] ITEMS_OPTIONAL_AMOUNTS = {GIANT_POUCH_DEG_AMOUNT, GIANT_POUCH_AMOUNT,LARGE_POUCH_AMOUNT,
            MEDIUM_POUCH_AMOUNT,SMALL_POUCH_AMOUNT};
    public static int[] ITEMS_EQUIPMENT = {ID_TIARA_AIR, ID_TIARA_ELEMENTAL, ID_TIARA_OMNI, ID_STEAM_STAFF, ID_STEAM_BATTLESTAFF,
            ID_BINDING_NECKLACE};
    public static int[] ITEMS_EQUIPMENT_AMOUNT = {TIARA_AIR_AMOUNT, TIARA_ELEMENTAL_AMOUNT, TIARA_OMNI_AMOUNT, STEAM_STAFF_AMOUNT,
